...
#include"../BackManger/WorkTimeTypeGridManger.h"

class CWorkTimeTypeView: public CBaseFormView
{
	DECLARE_DYNCREATE(CWorkTimeTypeView)
public:
	CWorkTimeTypeView();           // 动态创建所使用的受保护的构造函数
	virtual ~CWorkTimeTypeView();
...
private:
	...
	boost::scoped_ptr<CWorkTimeTypeGridManger>   m_gridManger;
