...
class CTextProgressCtrl : public CProgressCtrl
{
	...
	public:
		...
		inline COLORREF GetBarColor() const
			{ ASSERT(::IsWindow(m_hWnd)); return ((COLORREF) ::SendMessage(m_hWnd, TPBM_GETBARCOLOR, 0, 0)); }
		...
		inline COLORREF GetBarBkColor() const
			{ ASSERT(::IsWindow(m_hWnd)); return ((COLORREF) ::SendMessage(m_hWnd, TPBM_GETBKCOLOR, 0, 0)); }
