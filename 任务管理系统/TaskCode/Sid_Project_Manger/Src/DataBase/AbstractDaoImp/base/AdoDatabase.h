...
#import "C:\Program Files (x86)\Common Files\system\ado\msadox.dll" named_guids rename_namespace("ADOCG") rename("EOS","AdoEOS") rename("EOF", "adoXEOF")\
	rename("DataTypeEnum","adoXDataTypeEnum") rename("FieldAttributeEnum", "adoFielAttributeEnum")
#import "C:\Program Files (x86)\Common Files\system\ado\msado15.dll" rename("EOF","adoEOF") rename("DataTypeEnum","adoDataTypeEnum")
