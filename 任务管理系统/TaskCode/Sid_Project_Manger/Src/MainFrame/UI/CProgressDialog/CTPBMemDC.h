#ifndef _CTPBMEMDC_H_
#define _CTPBMEMDC_H_
...
class CTPBMemDC : public CDC				// T(text)P(progress)B(bar)MemDC
{
private:
...
public:
	...
	CTPBMemDC(CDC* pDC, const CRect* pRect = NULL) : CDC()
	{
	...
	CTPBMemDC* operator->() { return this; }

	// allow usage as a pointer
	operator CTPBMemDC*() { return this; }
};
