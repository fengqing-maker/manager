...
#ifndef DEBUG_GRID_CTRL
//#define DEBUG_GRID_CTRL
#endif
...
#define GVN_USER_BASE			 LVN_LAST-100		/* 允许用户自定义100个消息 */
#define GVN_VALIDATECELL		 GVN_USER_BASE+1	/* 验证表项 */
